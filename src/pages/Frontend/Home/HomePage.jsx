...
import bangladeshData from "../../../data/bangladeshData.json"; // Division → District → Thana JSON
                ...
                {totalPages > 1 && (
                  <div className="flex justify-center items-center gap-3 mt-6">
                    <button
                      ...
                      className="px-3 py-1 border rounded-lg bg-gray-100 hover:bg-gray-200 disabled:opacity-40"
                    >
                      Prev
                    </button>
